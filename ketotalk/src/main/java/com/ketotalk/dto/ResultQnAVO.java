...
public class ResultQnAVO {
	...
	public int getSelected_seq() {
		return selected_seq;
	}

	public void setSelected_seq(int selected_seq) {
	...
	public int getQt_q_seq() {
		return qt_q_seq;
	}

	public void setQt_q_seq(int qt_q_seq) {
		this.qt_q_seq = qt_q_seq;
	}
